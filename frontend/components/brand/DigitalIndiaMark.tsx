...
export function DigitalIndiaMark({ size = 36 }: { size?: number }) {
  ...
  return (
    <span className="inline-flex items-center overflow-visible" style={{ height: size, width }}>
      ...
      <img
        ...
        width={width}
        height={size}
        className="h-full w-full object-contain object-left object-top brightness-0 dark:brightness-0 dark:invert"
      />
    </span>
  );
}
